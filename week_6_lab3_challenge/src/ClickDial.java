...
public class ClickDial extends DialDecorator {
	...
	public ClickDial(int clicks,Dial dial){
		this.clicks = clicks;
		this.value = dial.value();
		dragStart = null;
